...
export default function EditServiceCategory({ category, establishment }: { category: ServiceCategory, establishment: Establishment }) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/business/service-categories/${category.id}`);
    };
                    ...
                    <Card className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
                        <CardContent className="pt-6">
                            <p className="text-sm text-blue-900 dark:text-blue-100">
                                <strong>📋 {category.services.length} servicio(s) asociado(s):</strong> {category.services.map(s => s.name).join(', ')}
                            </p>
                        </CardContent>
                    </Card>
                )}
                ...
                <form onSubmit={submit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Actualiza el nombre y características de la categoría
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="flex items-center justify-between py-2 border-t">
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Si desactivas la categoría, no aparecerá en el formulario de servicios
                                    </p>
                                </div>
                                <Switch
                                    id="is_active"
